...
$handler->display->display_options['fields']['php']['php_value'] = 'return "https://" . htmlspecialchars($_SERVER[\'SERVER_NAME\']) . "/category/" . str_replace(" ", "-", $row->name);';
